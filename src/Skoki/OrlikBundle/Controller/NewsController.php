...
use Skoki\OrlikBundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SkokiOrlikBundle:News')->findAll();

        return $this->render('SkokiOrlikBundle:News:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SkokiOrlikBundle:News:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SkokiOrlikBundle:News')->find($id);
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SkokiOrlikBundle:News:edit.html.twig', array(
            'entity'      => $entity,
